...
```{r closing-time, echo=F, fig.cap="Figure from course text, p. 40, 'Did the policy work'"}
...
```{r include-p-values-plot, fig.cap="Distribution of p-values in medical literature", echo=F, out.width="50%", out.height="50%"}
